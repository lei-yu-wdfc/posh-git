...
namespace Wonga.QA.Tests.Comms
{
    ...
    public class MobilePhoneTests
    {
        ...
        [Test, JIRA("SME-563"), Description("This test sends mobile phone verification message to predefined number")]
        ...
        //PLEASE PUT AUT ATTRIBUTE AFTER REVIEW
        [Test, JIRA("SME-563"), Description("This negative test attempts to send verification sms to invalid UK phone numbers and checks for expected failure")]
        ...
        //PLEASE PUT AUT ATTRIBUTE AFTER REVIEW
        [Test, JIRA("SME-563"), Description("This test covers the process of creating a new customer details record, initiates mobile phone verification and completes it with correct PIN")]
        ...
        //PLEASE PUT AUT ATTRIBUTE AFTER REVIEW
        [Test, JIRA("SME-563"), Description("This negative test covers the process of creating a new customer details record, initiates mobile phone verification and completes it with incorrect PIN, while checking for failure")]
        ...
        //PLEASE PUT AUT ATTRIBUTE AFTER REVIEW
        [Test, JIRA("SME-563"), Description("This test initiates the resend pin feature for new customer details record")]
