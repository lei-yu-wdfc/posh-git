...
namespace Wonga.QA.Tests.Marketing
{
    ...
    public class ServerSideTrackingTests
    {
        ...
        public void SaveServerSideInitialTrackingDataCommandTest()
        {
            ...
            var serverSideInitialtracingRecord = Do.Until(() => _marketingDb.ServerSideInitialTracking.FindBySessionId(sessionId));
        ...
        public void SaveServerSidePageTrackingDataCommandTest()
        {
            ...
            var serversideTrackingRecord = Do.Until(() => _marketingDb.ServerSidePageTracking.FindBySessionId((sessionId)));
        ...
        public void SaveServerSideTrackingDeviceCommandTest()
        {
            ...
            var trackingDeviceRecord = Do.Until(() => _marketingDb.ServerSideTrackingDevice.FindBySessionId((sessionId)));

            Assert.IsTrue(sessionId.Equals(trackingDeviceRecord.SessionId));
