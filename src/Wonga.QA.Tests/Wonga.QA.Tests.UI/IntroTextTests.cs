...
namespace Wonga.QA.Tests.Ui
{
    ...
    {
        private Dictionary<int, string> introTexts = new Dictionary<int, string>
                                                         {
                                                             {
                                                                 1,
                                                                 "Hi {first name}. Your current trust rating means you can apply for up to £{500} below."
                                                                 },
                                                             {
                                                                 2,
                                                                 "Hi {first name}. You currently have up to £{245.00} of available credit which you can request at any time."
                                                                 },
                                                             {
                                                                 3,
                                                                 "Hi {first name}. You currently have up to £{245.00} of available credit which you can request at any time."
                                                             ...
                                                             {
                                                                 5,
                                                                 "Hi {first name}. You don't currently have any available credit and you promised to repay £{425.00} on {Friday 13 Feb 2011}."
                                                                 },
                                                             {
                                                                 6,
                                                                 "Hi {first name}. You don't currently have any available credit and you promised to repay £{425.00} on {Friday 13 Feb 2011}."
                                                             ...
                                                             {
                                                                 8,
                                                                 "Hi {first name}. We collected your full payment of £{300} today, as promised.Many thanks for repaying our trust in you.You can now request your available credit up to your current Wonga trust rating of £{500}, at anytime. Thanks for using Wonga and we hope we can help again in the future."
                                                                 },
                                                             {
                                                                 9,
                                                                 "Hi {first name}. Your promised repayment of £{456.34}, due first thing today, was declined by your bank."
                                                                 },
                                                             {
                                                                 10,
                                                                 "Hi {first name}. Your repayment of £{456.34}, promised on {date}, was declined by your bank and is now overdue."
                                                                 },
                                                             {
                                                                 11,
                                                                 "Hi {first name}. Your account is now {26} days in arrears."
                                                                 },
                                                             {
                                                                 12,
                                                                 "Hi {first name}. We are disappointed that your account remains overdue and you are now {46} days in arrears."
                                                                 },
                                                             {
                                                                 13,
                                                                 "Hi {first name}. We are disappointed that your account remains overdue and you are now {61} days in arrears."
                                                                 },
                                                             {
                                                                 14,
                                                             ...
                                                             {
                                                                 15,
                                                                 "Hi {first name}. We were unable to collect a scheduled repayment towards your current repayment plan."
                                                                 },
                                                             {
                                                                 16,
                                                                 "Hi {first name}. You have missed a scheduled payment against your agreed repayment plan, which has now been cancelled."
                                                                 },
                                                             {17, "Hi {first name}."},
                                                             {19, "Hi {first name}."},
                                                             {
                                                                 20,
                                                                 "Hi {first name}. As a new customer you can apply for up to £{400} below."
                                                                 },
                                                             {21, "Hi {first name}."}
                                                         };
            ...
            // Ln journey
        {
            ...
            string expectedIntroText = introTexts[1];
            expectedIntroText =
                expectedIntroText.Replace("{first name}", customer.GetCustomerFullName().Split(' ')[0]).Replace(
                    "{500}", "400.00");
            Assert.IsTrue(mySummaryPage.IsBackEndScenarioCorrect(1));
            Assert.AreEqual(expectedIntroText, actuallntroText);
        }
        ...
        [Row(2, 1)]
        [Row(2, 2)]
        public void IntroTextScenario2(int scenarioId, int dayShift)
        {
            IntroText(scenarioId, dayShift);
        }
        ...
        public void IntroTextScenario9()
        {
            ...
            var expectedIntroText = introTexts[scenarioId].Replace("{first name}",
                                                                   customer.GetCustomerFullName().Split(' ')[0]);
            expectedIntroText = expectedIntroText.Replace("Your promised repayment of £{456.34}",
                                                          "Your promised repayment of £" +
                                                          expectedNextDueDateRepay.ToString("#.00"));
        ...
        public void IntroTextScenario10()
        {
            ...
            response = Drive.Api.Queries.Post(new GetFixedTermLoanApplicationQuery {ApplicationId = appId});
            var expectedBalanceToday = String.Format("{0:0.00}",
                                                     Convert.ToDecimal(response.Values["BalanceToday"].Single()));
            var expectedNextDueDate = Date.GetOrdinalDate(Convert.ToDateTime(response.Values["NextDueDate"].Single()),
                                                          "ddd d MMM yyyy");

            //Your repayment of £{456.34}, promised on {date}
            var expectedIntroText = introTexts[scenarioId].Replace("{first name}",
                                                                   customer.GetCustomerFullName().Split(' ')[0]);
            expectedIntroText = expectedIntroText.Replace("Your repayment of £{456.34}",
                                                          "Your repayment of £" + expectedBalanceToday);
        ...
        public void IntroTextScenario14()
        {
            ...
            var setupData = new AccountSummarySetupFunctions();
            setupData.Scenario14Setup(requestId1, requestId2, applicationId, accountId, appId, paymentCardId,
                                      bankAccountId);
        ...
        public void IntroTextScenario15()
        {
            ...
            var setupData = new AccountSummarySetupFunctions();
            setupData.Scenario15Setup(requestId1, requestId2, applicationId, accountId, appId, paymentCardId,
                                      bankAccountId);
        ...
        public void IntroTextScenario16()
        {
            ...
            var setupData = new AccountSummarySetupFunctions();
            setupData.Scenario16Setup(requestId1, requestId2, applicationId, accountId, appId, paymentCardId,
                                      bankAccountId);
        ...
        [Test, AUT(AUT.Uk), JIRA("UK-788")]
        public void IntroTextScenario20()
        {
            IntroText(20, 10);
        }
        ...
        private void IntroText(int scenarioId, params int[] days)
        {
            ...
            if (scenarioId == 20)
                customer =
                    CustomerBuilder.New().WithEmailAddress(email).WithEmployerStatus(
                        EmploymentStatusEnum.Unemployed.ToString()).WithMiddleName(RiskMask.TESTEmployedMask).Build();
            ...
            if (scenarioId < 5) application = ApplicationBuilder.New(customer).WithLoanTerm(loanTerm).Build();
                ...
                application =
                    ApplicationBuilder.New(customer).WithExpectedDecision(ApplicationDecisionStatus.Declined).
                        WithLoanTerm(loanTerm).Build();
            ...
            if (scenarioId == 8)
            {
                ...
                var PromoCodeId =
                    Drive.Api.Queries.Post(new GetFixedTermLoanApplicationQuery {ApplicationId = application.Id}).Values
                        ["PromoCodeId"].Single();
                expectedAmountMax =
            ...
            if (scenarioId == 11 || scenarioId == 12 || scenarioId == 13)
            {
                ...
                Drive.Msmq.Payments.Send(new CreateScheduledPaymentRequestCommand()
                                             {ApplicationId = application.Id, RepaymentRequestId = requestId1,});
                Drive.Msmq.Payments.Send(new CreateScheduledPaymentRequestCommand()
                                             {ApplicationId = application.Id, RepaymentRequestId = requestId2,});
            }
            ...
            expectedIntroText = expectedIntroText.Replace("You currently have up to £{245.00}",
                                                          "You currently have up to £" +
                                                          String.Format("{0:0.00}", expectedAvailableCredit));
            ...
            expectedIntroText = expectedIntroText.Replace("you promised to repay £{425.00}",
                                                          "you promised to repay £" +
                                                          String.Format("{0:0.00}", expectedNextDueDateRepay));
            expectedIntroText = expectedIntroText.Replace("on {Friday 13 Feb 2011}", "on " + expectedNextDueDate);
            expectedIntroText = expectedIntroText.Replace("We collected your full payment of £{300} today",
                                                          "We collected your full payment of £" + expectedDueDateBalance +
                                                          " today");
            expectedIntroText = expectedIntroText.Replace("your current Wonga trust rating of £{500}",
                                                          "your current Wonga trust rating of £" + expectedAmountMax);
            expectedIntroText = expectedIntroText.Replace("Your account is now {26}",
                                                          "Your account is now " + daysInArrears.Days.ToString("#"));
            expectedIntroText = expectedIntroText.Replace("you are now {46}",
                                                          "you are now " + daysInArrears.Days.ToString("#"));
            expectedIntroText = expectedIntroText.Replace("you are now {61}",
                                                          "you are now " + daysInArrears.Days.ToString("#"));
            expectedIntroText = expectedIntroText.Replace("you can apply for up to £{400}",
                                                          "you can apply for up to £" + expectedAmountMax);
