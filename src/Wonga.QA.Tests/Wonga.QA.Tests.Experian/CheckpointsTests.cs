...
namespace Wonga.QA.Tests.Experian
{
    ...
    public class CheckpointsTests
    {
        ...
        public void TestExperianUnknownApplicant_LoanIsApproved()
        {
            ...
            var customer = CustomerBuilder.New().WithMiddleName(RiskMiddlenameMask.TESTExperianApplicantIsNotDeceased.ToString()).WithForename(forename).WithSurname(surname).Build();
        ...
        public void TestExperianApplicantIsNotCifasFlagged_LoanIsApproved()
        {
            ...
            var customer = CustomerBuilder.New().WithMiddleName(RiskMiddlenameMask.TESTExperianApplicationElementNotCIFASFlagged.ToString()).WithForename(forename).WithSurname(surname).Build();
            var organization = OrganisationBuilder.New().WithPrimaryApplicant(customer).Build();
            var application = ApplicationBuilder.New(customer, organization).Build();
            Assert.IsNotNull(application);
        ...
        public void TestExperianApplicantIsSolvent_LoanIsApproved()
        {
            ...
            var customer = CustomerBuilder.New().WithMiddleName(RiskMiddlenameMask.TESTExperianApplicantIsSolvent.ToString()).WithForename(forename).WithSurname(surname).Build();
            var organization = OrganisationBuilder.New().WithPrimaryApplicant(customer).Build();
            var application = ApplicationBuilder.New(customer, organization).Build();
            Assert.IsNotNull(application);
        ...
        public void TestExperianDateOfBirthIsCorrect_LoanIsApproved()
        {
            ...
            var customer = CustomerBuilder.New().WithMiddleName(RiskMiddlenameMask.TESTExperianCustomerDateOfBirthIsCorrect.ToString()).WithForename(forename).WithSurname(surname).WithDateOfBirth(dateOfBirth).Build();
            var organization = OrganisationBuilder.New().WithPrimaryApplicant(customer).Build();
            var application = ApplicationBuilder.New(customer, organization).Build();
            Assert.IsNotNull(application);
