...
namespace Wonga.QA.Tests.Risk
{
    ...
    class RiskIovationPostcodeHandlersTest
    {
		...
		[Test, AUT(AUT.Ca), JIRA("CA-2469"), Owner(Owner.TarasKudryavtsev)]
        public void UpdateApplicationClosedOnHandlerTest()
        {
            ...
            Do.Until(() => (Drive.Data.Risk.Db.RiskApplication.FindByApplicationId(app.Id).ClosedOn) is DateTime);
