...
{
	[Parallelizable(TestScope.All), AUT(AUT.Za), Pending("ZA-2565")]
	public class CheckpointRepaymentPredictionPositiveTests
	{
		...
		[Test, AUT(AUT.Za), DependsOn("CheckpointRepaymentPredictionPositiveL0Accept"), Pending("ZA-2565")]
		...
		[Test, AUT(AUT.Za), DependsOn("CheckpointRepaymentPredictionPositiveLnAccept"), Pending("ZA-2565")]
