...
namespace Wonga.QA.Tests.Salesforce
{
    ...
    public class SalesforceApplicationStatusUpdateTests : SalesforceTestBase
    {
        ...
        [Test]
        [AUT(AUT.Uk), JIRA("UK-923"), Ignore("Ignored as Negative loan amount is not accepted when postive amount is provided DB transactions doesn't have amount marked as negative.SME needs to fix this"),Owner("Lisa Lambert")]
