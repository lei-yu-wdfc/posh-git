...
{
    public class MainBusinessBankAccountPage : BasePage
    {
        ...
        {
            set { _bankName.SelectOption(value); }
        }

        public String AccountNumber
        {
            set { _accountNumber.SendValue(value); }
        }

        public String BankPeriod
        {
            set { _bankPeriod.SelectOption(value); }
        }
        ...
        public MainBusinessBankAccountPage(UiClient client)
            : base(client)
        {
            _form = Content.FindElement(By.Id("lzero-business-bank-form"));
