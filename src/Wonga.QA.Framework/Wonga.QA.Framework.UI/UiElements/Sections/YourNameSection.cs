...
namespace Wonga.QA.Framework.UI.UiElements.Sections
{
    public class YourNameSection : BaseSection
    {
        ...
        public YourNameSection(BasePage page) : base(Elements.Get.YourNameSection.Fieldset, page)
        {
            ...
            _middleName = Section.FindElement(By.CssSelector(Elements.Get.YourNameSection.MiddleName));
            _lastName = Section.FindElement(By.CssSelector(Elements.Get.YourNameSection.LastName));
        }
