...
namespace Wonga.QA.Framework.UI.UiElements.Pages.Wb
{
    public class BusinessBankAccountPage : BasePage
    {
        ...
        {
            _form = Content.FindElement(By.Id(Elements.Get.WbBusinessBankAccountPage.FormId));
            _next = _form.FindElement(By.Name(Elements.Get.WbBusinessBankAccountPage.NextButton));
