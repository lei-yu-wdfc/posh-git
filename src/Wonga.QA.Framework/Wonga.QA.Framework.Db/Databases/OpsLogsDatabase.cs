...
namespace Wonga.QA.Framework.Db.OpsLogs
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="OpsLogs")]
    ...
    partial void OnApplicationIdChanged();
		...
		[Column(Storage="_Endpoint", DbType="VarChar(50)")]
		...
		[Column(Storage="_Thread", DbType="VarChar(255)")]
		...
		[Column(Storage="_Level", DbType="VarChar(50)")]
		public string Level
		{
			get
			{
		...
		[Column(Storage="_Logger", DbType="VarChar(255)")]
		...
		[Column(Storage="_Message", DbType="VarChar(MAX)", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Exception", DbType="VarChar(MAX)", UpdateCheck=UpdateCheck.Never)]
