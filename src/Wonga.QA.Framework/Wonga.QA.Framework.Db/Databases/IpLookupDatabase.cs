...
namespace Wonga.QA.Framework.Db.IpLookup
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="IpLookup")]
    ...
    partial void OnCityChanged();
		...
		[Column(Storage="_Ip2LocationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_IpFrom", DbType="Float NOT NULL")]
		...
		[Column(Storage="_IpTo", DbType="Float NOT NULL")]
		public double IpTo
		{
			get
			{
		...
		[Column(Storage="_CountryShort", DbType="NVarChar(2)")]
		...
		[Column(Storage="_Region", DbType="NVarChar(128)")]
