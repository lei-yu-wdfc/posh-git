...
namespace Wonga.QA.Framework.Db.FileStorage
{
    ...
    partial void OnCharacterEncodingChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CharacterEncoding", DbType="VarChar(50)")]
		public string CharacterEncoding
		{
			...
			set
			{
				if ((this._CharacterEncoding != value))
				{
					this.OnCharacterEncodingChanging(value);
					this.SendPropertyChanging();
					this._CharacterEncoding = value;
					this.SendPropertyChanged("CharacterEncoding");
