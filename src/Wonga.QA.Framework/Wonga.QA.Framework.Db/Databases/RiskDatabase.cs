...
namespace Wonga.QA.Framework.Db.Risk
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Risk")]
	...
	[Table(Name="risk.ApplicationBehaviour")]
    ...
    partial void OnSliderAmountPositionChanged();
		...
		[Column(Storage="_ApplicationBehaviourId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_SliderTermPosition", DbType="TinyInt NOT NULL")]
		...
		[Column(Storage="_SliderAmountPosition", DbType="TinyInt NOT NULL")]
		...
		[Association(Name="FK_RiskApplications_ApplicationBehaviour", Storage="_RiskApplications", ThisKey="ApplicationBehaviourId", OtherKey="ApplicationBehaviourId", DeleteRule="NO ACTION")]
	...
	[Table(Name="risk.CheckpointDefinitions")]
    ...
    partial void OnCheckpointIdChanged();
		...
		[Column(Storage="_CheckpointDefinitionId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_TypeName", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_FailedDescription", DbType="VarChar(128) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ResolutionAdviceKey", DbType="VarChar(50)")]
		...
		[Column(Storage="_CheckpointId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Association(Name="FK_WorkflowCheckpoints_CheckpointDefinitions", Storage="_WorkflowCheckpoints", ThisKey="CheckpointDefinitionId", OtherKey="CheckpointDefinitionId", DeleteRule="NO ACTION")]
	...
	[Table(Name="risk.ConfigurationRecords")]
    ...
    partial void OnDataChanged();
		...
		[Column(Storage="_ConfigurationRecordId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Data", DbType="VarChar(768) NOT NULL", CanBeNull=false)]
		public string Data
		{
			get
			{
		...
		[Association(Name="FK_WorkflowVerifications_ConfigurationRecords", Storage="_WorkflowVerifications", ThisKey="ConfigurationRecordId", OtherKey="ConfigurationRecordId", DeleteRule="NO ACTION")]
	...
	[Table(Name="risk.CreditBureauDataCache")]
    ...
    partial void OnAccountIdChanged();
		...
		[Column(Storage="_CreditBureauDataCacheId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CreditBureauData", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
	...
	[Table(Name="risk.CreditBureauDataExtracted")]
    ...
    partial void OnCifasFillingsChanged();
		...
		[Column(Storage="_CreditBureauDataExtractedId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_RequestApplicant", DbType="Xml NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Picklist", DbType="Xml NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ResidentMatches", DbType="Xml", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Cifas", DbType="Xml", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_CifasFillings", DbType="Xml", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
	...
	[Table(Name="risk.CustomerDetailChanges")]
    ...
    partial void OnContactDetailsComparedToLastApplicationChanged();
		...
		[Column(Storage="_CustomerDetailChangesId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PersonalDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_BankDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_CardDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_PersonalDetailsComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_BankDetailsComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_CardDetailsComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_SaveButtonTransactions", DbType="Int NOT NULL")]
		...
		[Column(Storage="_AddressStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_AddressComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_SocialDetailsComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_SocialDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_FieldChangesInSocialDetailsComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_FieldChangesInSocialDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_EmploymentDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_EmploymentDetailsComparedToLastApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ContactDetailsStartingFromFirstApplication", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ContactDetailsComparedToLastApplication", DbType="Int NOT NULL")]
	...
	[Table(Name="risk.DecisionDataDefinitions")]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_DecisionDataDefinitionId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="FK_RiskDecisionData_DecisionDataDefinitions", Storage="_RiskDecisionDatas", ThisKey="DecisionDataDefinitionId", OtherKey="DecisionDataDefinitionId", DeleteRule="NO ACTION")]
	...
	[Table(Name="risk.EmploymentDetails")]
    ...
    partial void OnPaidDirectDepositChanged();
		...
		[Column(Storage="_EmploymentDetailsId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_EmployerName", DbType="NVarChar(100)")]
		...
		[Column(Storage="_EmploymentIndustry", DbType="Int")]
		...
		[Column(Storage="_EmploymentPosition", DbType="Int")]
		...
		[Column(Storage="_IncomeFrequency", DbType="Int")]
		...
		[Column(Storage="_NetMonthlyIncome", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_NextPayDate", DbType="Date")]
		...
		[Column(Storage="_PaidDirectDeposit", DbType="Bit")]
    ...
    partial void OnDataTypeIdChanged();
		...
		[Column(Storage="_FactorId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int FactorId
		{
			get
			{
	...
	[Table(Name="risk.IovationDetails")]
    ...
    partial void OnDateCreatedChanged();
		...
		[Column(Storage="_IovationDetailId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_IovationResultId", DbType="Int")]
		...
		[Column(Storage="_KeyName", DbType="VarChar(50)")]
		...
		[Column(Storage="_Value", DbType="VarChar(256) NOT NULL", CanBeNull=false)]
		public string Value
		{
			get
			{
		...
		[Association(Name="FK_IovationDetails_IovationResultId", Storage="_IovationResultEntity", ThisKey="IovationResultId", OtherKey="IovationResultId", IsForeignKey=true)]
	...
	[Table(Name="risk.IovationResults")]
    ...
    partial void OnDateCreatedChanged();
		...
		[Column(Storage="_IovationResultId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_DeviceAlias", DbType="VarChar(50)")]
		...
		[Column(Storage="_Result", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_TrackingNumber", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="FK_IovationDetails_IovationResultId", Storage="_IovationDetails", ThisKey="IovationResultId", OtherKey="IovationResultId", DeleteRule="NO ACTION")]
    ...
    partial void OnDataChanged();
		...
		[Column(Storage="_PmmlFactorId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_FactorId", DbType="Int NOT NULL")]
		public int FactorId
		{
			get
			{
		...
		[Column(Storage="_RiskApplicationId", DbType="Int NOT NULL")]
		...
		[Column(Storage="_Data", DbType="VarChar(50)")]
		public string Data
		{
			get
			{
		...
		[Association(Name="PK_PmmlFactors_RiskApplications", Storage="_RiskApplicationEntity", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", IsForeignKey=true)]
    ...
    partial void OnPlaceChanged();
		...
		[Column(Storage="_PostcodeUKId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Postcode", DbType="VarChar(7) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Place", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string Place
		{
			get
			{
	...
	[Table(Name="risk.RiskAccountHomePhones")]
    ...
    partial void OnDateUpdatedChanged();
		...
		[Column(Storage="_RiskAccountHomePhoneId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_HomePhone", DbType="VarChar(16) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="risk.RiskAccountMobilePhones")]
    ...
    partial void OnDateUpdatedChanged();
		...
		[Column(Storage="_RiskAccountMobilePhoneId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_MobilePhone", DbType="VarChar(16) NOT NULL", CanBeNull=false)]
    ...
    partial void OnAtAddressFromChanged();
		...
		[Column(Storage="_RiskAccountId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_AccountRank", DbType="Int NOT NULL")]
		...
		[Column(Storage="_IsDebtSale", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_ConfirmedFraud", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_SubRegion", DbType="NVarChar(50)")]
		...
		[Column(Storage="_DoNotRelend", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_MaidenName", DbType="NVarChar(50)")]
		...
		[Column(Storage="_HasAccount", DbType="Bit NOT NULL")]
	...
	[Table(Name="risk.RiskApplications")]
    ...
    partial void OnMainCardRepayRateChanged();
		...
		[Column(Storage="_RiskApplicationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int RiskApplicationId
		{
			get
			{
		...
		[Column(Storage="_ApplicationDate", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_PaymentCardId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_BankAccountId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_OriginalLoanAmount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_IsCounterOffer", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_ArrearsStartDate", DbType="DateTime")]
		...
		[Column(Storage="_InArrearsDays", DbType="Int")]
		...
		[Column(Storage="_CreditLimit", DbType="Decimal(18,0) NOT NULL")]
		public decimal CreditLimit
		{
			get
			{
		...
		[Column(Storage="_TermLimit", DbType="Int NOT NULL")]
		...
		[Column(Storage="_NCOAccepted", DbType="Bit")]
		...
		[Column(Storage="_PCOAccepted", DbType="Bit")]
		...
		[Column(Storage="_WasExtended", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_WasTopUp", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_UsedManualVerification", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_PaymentTransactionCount", DbType="Int")]
		...
		[Column(Storage="_ManualPaymentTransactionCount", DbType="Int")]
		...
		[Column(Storage="_Decision", DbType="TinyInt")]
		...
		[Column(Storage="_EstimatedCompletionDate", DbType="DateTime")]
		...
		[Column(Storage="_CreditBureauUsed", DbType="TinyInt")]
		...
		[Column(Storage="_ApplicationBehaviourId", DbType="Int")]
		...
		[Column(Storage="_FICOScore", DbType="Float")]
		...
		[Column(Storage="_MainCardRepayRate", DbType="Float")]
		...
		[Association(Name="FK_RiskApplications_ApplicationBehaviour", Storage="_ApplicationBehaviourEntity", ThisKey="ApplicationBehaviourId", OtherKey="ApplicationBehaviourId", IsForeignKey=true)]
		...
		[Association(Name="FK_RiskBusinessApplications_RiskBusinessApplicationId", Storage="_RiskBusinessApplicationEntity", ThisKey="RiskApplicationId", OtherKey="RiskBusinessApplicationId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_UserActions_RiskApplications", Storage="_UserActions", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="PK_PmmlFactors_RiskApplications", Storage="_PmmlFactors", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="PK_RiskDecisionData_RiskApplications", Storage="_RiskDecisionDatas", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", DeleteRule="NO ACTION")]
		public EntitySet<RiskDecisionDataEntity> RiskDecisionDatas
		{
			get
			{
		...
		[Association(Name="PK_WorkflowCheckpoints_RiskApplications", Storage="_WorkflowCheckpoints", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", DeleteRule="NO ACTION")]
		public EntitySet<WorkflowCheckpointEntity> WorkflowCheckpoints
		{
			get
			{
		...
		[Association(Name="PK_WorkflowVerifications_RiskApplications", Storage="_WorkflowVerifications", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", DeleteRule="NO ACTION")]
		public EntitySet<WorkflowVerificationEntity> WorkflowVerifications
		{
			get
			{
	...
	[Table(Name="risk.RiskBankAccounts")]
    ...
    partial void OnAcceptsDebitsChanged();
		...
		[Column(Storage="_RiskBankAccountId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_BankName", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_AccountNumberHash", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_IsValidated", DbType="Bit")]
		...
		[Column(Storage="_ValidatedOn", DbType="DateTime")]
		...
		[Column(Storage="_IsActiveMoreThanThreeMonths", DbType="Bit")]
		...
		[Column(Storage="_AcceptsCredits", DbType="Bit")]
		...
		[Column(Storage="_AcceptsDebits", DbType="Bit")]
	...
	[Table(Name="risk.RiskBusinessApplications")]
    ...
    partial void OnBusinessPaymentCardIdChanged();
		...
		[Column(Storage="_RiskBusinessApplicationId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_BusinessBankAccountId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_BusinessPaymentCardId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Association(Name="FK_RiskBusinessApplications_RiskBusinessApplicationId", Storage="_RiskApplicationEntity", ThisKey="RiskBusinessApplicationId", OtherKey="RiskApplicationId", IsForeignKey=true)]
		public RiskApplicationEntity RiskApplicationEntity
		{
			get
			{
	...
	[Table(Name="risk.RiskDecisionData")]
    ...
    partial void OnValueDoubleChanged();
		...
		[Column(Storage="_RiskDecisionDataId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_DecisionDataDefinitionId", DbType="Int NOT NULL")]
		public int DecisionDataDefinitionId
		{
			get
			{
		...
		[Column(Storage="_ValueDouble", DbType="Float")]
		...
		[Association(Name="FK_RiskDecisionData_DecisionDataDefinitions", Storage="_DecisionDataDefinitionEntity", ThisKey="DecisionDataDefinitionId", OtherKey="DecisionDataDefinitionId", IsForeignKey=true)]
		...
		[Association(Name="PK_RiskDecisionData_RiskApplications", Storage="_RiskApplicationEntity", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", IsForeignKey=true)]
		public RiskApplicationEntity RiskApplicationEntity
		{
			get
			{
	...
	[Table(Name="risk.RiskPaymentCards")]
    ...
    partial void OnCardNumberHashChanged();
		...
		[Column(Storage="_RiskPaymentCardId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CardType", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_CardNumberHash", DbType="BigInt NOT NULL")]
    ...
    partial void OnVehicleRegistrationChanged();
		...
		[Column(Storage="_SocialDetailsId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_MaritalStatus", DbType="Int NOT NULL")]
		...
		[Column(Storage="_OccupancyStatus", DbType="Int NOT NULL")]
		...
		[Column(Storage="_Dependants", DbType="Int NOT NULL")]
		...
		[Column(Storage="_VehicleRegistration", DbType="VarChar(10)")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_UserActionId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_UserActionTypeId", DbType="Int NOT NULL")]
		...
		[Column(Storage="_StatusData", DbType="VarChar(MAX)", UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="FK_UserActions_RiskApplications", Storage="_RiskApplicationEntity", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", IsForeignKey=true)]
		public RiskApplicationEntity RiskApplicationEntity
		{
			get
			{
		...
		[Association(Name="FK_UserActions_UserActionTypes", Storage="_UserActionTypeEntity", ThisKey="UserActionTypeId", OtherKey="UserActionTypeId", IsForeignKey=true)]
	...
	[Table(Name="risk.UserActionTypes")]
    ...
    partial void OnPriorityChanged();
		...
		[Column(Storage="_UserActionTypeId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int UserActionTypeId
		{
			get
			{
		...
		[Column(Storage="_Description", DbType="VarChar(256) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="FK_UserActions_UserActionTypes", Storage="_UserActions", ThisKey="UserActionTypeId", OtherKey="UserActionTypeId", DeleteRule="NO ACTION")]
		public EntitySet<UserActionEntity> UserActions
		{
			get
			{
	...
	[Table(Name="risk.VerificationDefinitions")]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_VerificationDefinitionId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="FK_WorkflowVerifications_VerificationDefinitions", Storage="_WorkflowVerifications", ThisKey="VerificationDefinitionId", OtherKey="VerificationDefinitionId", DeleteRule="NO ACTION")]
		public EntitySet<WorkflowVerificationEntity> WorkflowVerifications
		{
			get
			{
	...
	[Table(Name="risk.WorkflowCheckpoints")]
    ...
    partial void OnResponsibleVerificationIdChanged();
		...
		[Column(Storage="_WorkflowCheckpointId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CheckpointDefinitionId", DbType="Int NOT NULL")]
		public int CheckpointDefinitionId
		{
			get
			{
		...
		[Column(Storage="_CheckpointStatus", DbType="TinyInt NOT NULL")]
		...
		[Column(Storage="_ResponsibleVerificationId", DbType="Int")]
		...
		[Association(Name="FK_WorkflowCheckpoints_CheckpointDefinitions", Storage="_CheckpointDefinitionEntity", ThisKey="CheckpointDefinitionId", OtherKey="CheckpointDefinitionId", IsForeignKey=true)]
		...
		[Association(Name="FK_WorkflowCheckpoints_WorkflowVerifications", Storage="_WorkflowVerificationEntity", ThisKey="ResponsibleVerificationId", OtherKey="WorkflowVerificationId", IsForeignKey=true)]
		...
		[Association(Name="FK_WorkflowVerifications_WorkflowCheckpoints", Storage="_WorkflowVerifications", ThisKey="WorkflowCheckpointId", OtherKey="WorkflowCheckpointId", DeleteRule="NO ACTION")]
		public EntitySet<WorkflowVerificationEntity> WorkflowVerifications
		{
			get
			{
		...
		[Association(Name="PK_WorkflowCheckpoints_RiskApplications", Storage="_RiskApplicationEntity", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", IsForeignKey=true)]
		public RiskApplicationEntity RiskApplicationEntity
		{
			get
			{
	...
	[Table(Name="risk.WorkflowVerifications")]
    ...
    partial void OnWorkflowCheckpointIdChanged();
		...
		[Column(Storage="_WorkflowVerificationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_VerificationDefinitionId", DbType="Int NOT NULL")]
		public int VerificationDefinitionId
		{
			get
			{
		...
		[Column(Storage="_Executed", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_ConfigurationRecordId", DbType="Int")]
		...
		[Column(Storage="_WorkflowCheckpointId", DbType="Int")]
		...
		[Association(Name="FK_WorkflowCheckpoints_WorkflowVerifications", Storage="_WorkflowCheckpoints", ThisKey="WorkflowVerificationId", OtherKey="ResponsibleVerificationId", DeleteRule="NO ACTION")]
		public EntitySet<WorkflowCheckpointEntity> WorkflowCheckpoints
		{
			get
			{
		...
		[Association(Name="FK_WorkflowVerifications_ConfigurationRecords", Storage="_ConfigurationRecordEntity", ThisKey="ConfigurationRecordId", OtherKey="ConfigurationRecordId", IsForeignKey=true)]
		...
		[Association(Name="FK_WorkflowVerifications_VerificationDefinitions", Storage="_VerificationDefinitionEntity", ThisKey="VerificationDefinitionId", OtherKey="VerificationDefinitionId", IsForeignKey=true)]
		...
		[Association(Name="FK_WorkflowVerifications_WorkflowCheckpoints", Storage="_WorkflowCheckpointEntity", ThisKey="WorkflowCheckpointId", OtherKey="WorkflowCheckpointId", IsForeignKey=true)]
		...
		[Association(Name="PK_WorkflowVerifications_RiskApplications", Storage="_RiskApplicationEntity", ThisKey="RiskApplicationId", OtherKey="RiskApplicationId", IsForeignKey=true)]
		public RiskApplicationEntity RiskApplicationEntity
		{
			get
			{
