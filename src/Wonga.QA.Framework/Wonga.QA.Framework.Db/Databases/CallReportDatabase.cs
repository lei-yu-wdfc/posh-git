...
namespace Wonga.QA.Framework.Db.CallReport
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="CallReport")]
	...
	[Table(Name="callreport.AgreementRef")]
	public partial class AgreementRefEntity : DbEntity<AgreementRefEntity>
	{
		...
		[Column(Storage="_AgreementRefId", AutoSync=AutoSync.Always, DbType="Int NOT NULL IDENTITY", IsDbGenerated=true)]
		...
		[Column(Storage="_AgreementReference", DbType="VarChar(12) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="cache.CallReportActiveRequest")]
    ...
    partial void OnTotalMillisecondsChanged();
		...
		[Column(Storage="_ActiveRequestId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_RequestHash", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_ResponseData", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_TotalMilliseconds", DbType="Int")]
    ...
    partial void OnDataTypeIdChanged();
		...
		[Column(Storage="_FactorId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int FactorId
		{
			get
			{
		...
		[Association(Name="FK_Callreport_Factors_TypeId", Storage="_TypeEntity", ThisKey="DataTypeId", OtherKey="Id", IsForeignKey=true)]
		...
		[Association(Name="FK_Callreport_ParsedFactors_FactorId", Storage="_ParsedFactors", ThisKey="FactorId", OtherKey="FactorId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_Callreport_TempParsedFactors_FactorId", Storage="_ParsedFactorsTemps", ThisKey="FactorId", OtherKey="FactorId", DeleteRule="NO ACTION")]
	...
	[Table(Name="callreport.ParsedFactors")]
    ...
    partial void OnNumRecordChanged();
		...
		[Column(Storage="_ParsedFactorId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CustomerId", DbType="VarChar(12) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_NumRecord", DbType="TinyInt")]
		...
		[Association(Name="FK_Callreport_ParsedFactors_FactorId", Storage="_FactorEntity", ThisKey="FactorId", OtherKey="FactorId", IsForeignKey=true)]
	...
	[Table(Name="callreport.ParsedFactorsTemp")]
    ...
    partial void OnNumRecordChanged();
		...
		[Column(Storage="_ParsedFactorTempId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="FK_Callreport_TempParsedFactors_FactorId", Storage="_FactorEntity", ThisKey="FactorId", OtherKey="FactorId", IsForeignKey=true)]
		public FactorEntity FactorEntity
		{
			get
			{
    ...
    partial void OnNameChanged();
		...
		[Association(Name="FK_Callreport_Factors_TypeId", Storage="_Factors", ThisKey="Id", OtherKey="DataTypeId", DeleteRule="NO ACTION")]
