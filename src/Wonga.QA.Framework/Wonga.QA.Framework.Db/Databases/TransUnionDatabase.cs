...
namespace Wonga.QA.Framework.Db.TransUnion
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="TransUnion")]
	...
	[Table(Name="transunion.LoanRegistration")]
    ...
    partial void OnCreationDateChanged();
		...
		[Column(Storage="_LoanRegistrationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ApplicationGuid", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_NLRLoanRegNo", DbType="VarChar(14)")]
		...
		[Column(Storage="_Status", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
