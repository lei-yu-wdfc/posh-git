...
namespace Wonga.QA.Framework.Db.ExperianBulk
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="ExperianBulk")]
    ...
    partial void OnCreatedDateChanged();
		...
		[Column(Storage="_AddressDetails1", DbType="VarChar(100)")]
		...
		[Column(Storage="_AddressDetails2", DbType="VarChar(100)")]
		...
		[Column(Storage="_AddressDetails3", DbType="VarChar(100)")]
		...
		[Column(Storage="_AddressDetails4", DbType="VarChar(100)")]
		...
		[Column(Storage="_PostCode", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
    ...
    partial void OnTypeIdChanged();
		...
		[Association(Name="FK_Experian_ParsedData_Factors_FactorId", Storage="_ParsedDatas", ThisKey="FactorId", OtherKey="FactorId", DeleteRule="NO ACTION")]
	...
	[Table(Name="experian.Operations")]
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_OperationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	...
	[Table(Name="experian.ParsedData")]
    ...
    partial void OnAccountIdChanged();
		...
		[Column(Storage="_ParsedDataId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="FK_Experian_ParsedData_Factors_FactorId", Storage="_FactorEntity", ThisKey="FactorId", OtherKey="FactorId", IsForeignKey=true)]
	...
	[Table(Name="experian.ParsedDataTemp")]
    ...
    partial void OnCustomerIdChanged();
		...
		[Column(Storage="_ParsedDataTempId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
