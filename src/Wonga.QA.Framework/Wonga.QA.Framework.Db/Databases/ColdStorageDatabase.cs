...
namespace Wonga.QA.Framework.Db.ColdStorage
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="ColdStorage")]
	...
	[Table(Name="ColdStorage.PaymentCards")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_PaymentCardId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Number", DbType="VarBinary(512)", CanBeNull=true)]
		...
		[Column(Storage="_CV2", DbType="VarBinary(512)", CanBeNull=true)]
