...
namespace Wonga.QA.Framework.Db.Sms
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Sms")]
    ...
    partial void OnServiceMsgIdChanged();
		...
		[Column(Storage="_SmsMessageId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ReturnAddress", DbType="NVarChar(500)")]
		...
		[Column(Storage="_ErrorMessage", DbType="NVarChar(255)")]
		...
		[Column(Storage="_MobilePhoneNumber", DbType="VarChar(20) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ServiceMsgId", DbType="VarChar(50)")]
