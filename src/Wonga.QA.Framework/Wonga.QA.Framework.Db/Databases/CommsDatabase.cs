...
namespace Wonga.QA.Framework.Db.Comms
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Comms")]
    ...
    partial void OnProvinceChanged();
		...
		[Column(Storage="_Flat", DbType="NVarChar(20)")]
		public string Flat
		{
			get
			{
		...
		[Column(Storage="_HouseName", DbType="NVarChar(32)")]
		...
		[Column(Storage="_HouseNumber", DbType="NVarChar(32)")]
		...
		[Column(Storage="_Street", DbType="NVarChar(40)")]
		...
		[Column(Storage="_District", DbType="NVarChar(40)")]
		...
		[Column(Storage="_CountryCode", DbType="Int")]
		...
		[Column(Storage="_Province", DbType="NVarChar(200)")]
		...
		[Association(Name="FK_AddressesCa_AddressId", Storage="_AddressesCas", ThisKey="AddressId", OtherKey="AddressId", DeleteRule="NO ACTION")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_AddressesCaId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PoBox", DbType="NVarChar(40)")]
		public string PoBox
		{
			get
			{
		...
		[Association(Name="FK_AddressesCa_AddressId", Storage="_AddressEntity", ThisKey="AddressId", OtherKey="AddressId", IsForeignKey=true)]
	...
	[Table(Name="comms.ContactPreferences")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_ContactPreferenceId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	...
	[Table(Name="comms.CustomerDetails")]
    ...
    partial void OnMaidenNameChanged();
		...
		[Column(Storage="_CustomerDetailId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Title", DbType="Int")]
		...
		[Column(Storage="_HomePhone", DbType="VarChar(16)")]
		...
		[Column(Storage="_MobilePhone", DbType="VarChar(16)")]
		...
		[Column(Storage="_WorkPhone", DbType="VarChar(16)")]
		...
		[Column(Storage="_NationalNumber", DbType="NVarChar(13)")]
		...
		[Column(Storage="_MarriedInCommunityProperty", DbType="Bit")]
		...
		[Association(Name="FK_CustomerDetailsZa_CustomerDetailId", Storage="_CustomerDetailsZaEntity", ThisKey="CustomerDetailId", OtherKey="CustomerDetailId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
	...
	[Table(Name="comms.CustomerDetailsZa")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_CustomerDetailZaId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CustomerDetailId", DbType="Int NOT NULL")]
		public int CustomerDetailId
		{
			get
			{
		...
		[Column(Storage="_HomeLanguage", DbType="Int")]
		...
		[Association(Name="FK_CustomerDetailsZa_CustomerDetailId", Storage="_CustomerDetailEntity", ThisKey="CustomerDetailId", OtherKey="CustomerDetailId", IsForeignKey=true)]
	...
	[Table(Name="comms.CustomerLeads")]
    ...
    partial void OnProvinceChanged();
		...
		[Column(Storage="_CustomerLeadId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_RejectedDate", DbType="Date NOT NULL")]
	...
	[Table(Name="comms.EmailVerification")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_EmailVerificationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ChangeId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_VerifiedOn", DbType="DateTime")]
	...
	[Table(Name="comms.ExtensionReminderPreferences")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_ExtensionReminderPreferenceId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ExtensionReminderPreference", DbType="Int NOT NULL")]
	...
	[Table(Name="comms.LegalDocuments")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_DocumentType", DbType="TinyInt NOT NULL")]
	...
	[Table(Name="comms.MobilePhoneVerification")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_MobilePhoneVerificationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_VerificationId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_Pin", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string Pin
		{
			get
			{
		...
		[Column(Storage="_MobileVerifiedOn", DbType="DateTime")]
	...
	[Table(Name="comms.PhoneVerification")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_PhoneVerificationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Phone", DbType="VarChar(16) NOT NULL", CanBeNull=false)]
		public string Phone
		{
			get
			{
	...
	[Table(Name="comms.VerificationPins")]
    ...
    partial void OnMobileVerifiedOnChanged();
		...
		[Column(Storage="_VerificationPinId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
