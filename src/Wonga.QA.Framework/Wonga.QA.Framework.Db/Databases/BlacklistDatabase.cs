...
namespace Wonga.QA.Framework.Db.Blacklist
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Blacklist")]
	...
	[Table(Name="blacklist.BlackList")]
    ...
    partial void OnExternalIdChanged();
		...
		[Column(Storage="_BlackListId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_HomePhone", DbType="NVarChar(50)")]
		...
		[Column(Storage="_WorkPhone", DbType="NVarChar(50)")]
		...
		[Column(Storage="_BankAccount", DbType="NVarChar(50)")]
		...
		[Column(Storage="_SortCode", DbType="NVarChar(50)")]
