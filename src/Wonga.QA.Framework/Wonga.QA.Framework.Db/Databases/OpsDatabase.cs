...
namespace Wonga.QA.Framework.Db.Ops
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Ops")]
    ...
    partial void OnSaltChanged();
		...
		[Column(Storage="_Login", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string Login
		{
			get
			{
		...
		[Column(Storage="_Password", DbType="VarBinary(64) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Salt", DbType="VarBinary(8) NOT NULL", CanBeNull=false)]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_ApiClientId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_AuthToken", DbType="UniqueIdentifier NOT NULL")]
    ...
    partial void OnDataChanged();
		...
		[Column(Storage="_BinarySagaId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_SagaId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_SagaType", DbType="VarChar(128) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Data", DbType="VarBinary(MAX)", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_EndpointId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="FK_ops_EndpointSettings_EndpointId", Storage="_EndpointSettings", ThisKey="EndpointId", OtherKey="EndpointId", DeleteRule="NO ACTION")]
	...
	[Table(Name="ops.EndpointSettings")]
    ...
    partial void OnValueChanged();
		...
		[Column(Storage="_EndpointSettingId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_EndpointId", DbType="Int")]
		...
		[Association(Name="FK_ops_EndpointSettings_EndpointId", Storage="_EndpointEntity", ThisKey="EndpointId", OtherKey="EndpointId", IsForeignKey=true)]
	...
	[Table(Name="ops.PasswordRecoveryDetails")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_PasswordRecoveryDetailId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_SecretQuestion", DbType="VarChar(256) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_SecretAnswer", DbType="VarChar(128) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ExpiredOn", DbType="DateTime")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_PwdResetKeyId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_UniqueKey", DbType="VarChar(128) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ResetDate", DbType="DateTime")]
	...
	[Table(Name="ops.ServiceConfigurations")]
    ...
    partial void OnValueChanged();
		...
		[Column(Storage="_ServiceConfigurationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Key", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		public string Key
		{
			get
			{
