...
namespace Wonga.QA.Framework.Db.Salesforce
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Salesforce")]
	...
	[Table(Name="salesforce.SalesforceAccounts")]
    ...
    partial void OnSalesforceIdChanged();
		...
		[Column(Storage="_SalesforceAccountId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_SalesforceId", DbType="VarChar(40) NOT NULL", CanBeNull=false)]
