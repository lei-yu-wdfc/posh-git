...
namespace Wonga.QA.Framework.Db.Scheduler
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Scheduler")]
	...
	[Table(Name="dbo.QRTZ_BLOB_TRIGGERS")]
	public partial class QRTZ_BLOB_TRIGGER : DbEntity<QRTZ_BLOB_TRIGGER>
	{
		...
		[Column(Storage="_TRIGGER_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_TRIGGER_GROUP", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_BLOB_DATA", DbType="Image", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
    ...
    partial void OnCALENDARChanged();
		...
		[Column(Storage="_CALENDAR_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_CALENDAR", DbType="Image NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
	...
	[Table(Name="dbo.QRTZ_CRON_TRIGGERS")]
    ...
    partial void OnTIME_ZONE_IDChanged();
		...
		[Column(Storage="_TRIGGER_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string TRIGGER_NAME
		{
			get
			{
		...
		[Column(Storage="_TRIGGER_GROUP", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string TRIGGER_GROUP
		{
			get
			{
		...
		[Column(Storage="_CRON_EXPRESSION", DbType="VarChar(120) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_TIME_ZONE_ID", DbType="VarChar(80)")]
		...
		[Association(Name="FK_QRTZ_CRON_TRIGGERS_QRTZ_TRIGGERS", Storage="_QRTZ_TRIGGER", ThisKey="TRIGGER_NAME,TRIGGER_GROUP", OtherKey="TRIGGER_NAME,TRIGGER_GROUP", IsForeignKey=true, DeleteOnNull=true)]
	...
	[Table(Name="dbo.QRTZ_FIRED_TRIGGERS")]
    ...
    partial void OnREQUESTS_RECOVERYChanged();
		...
		[Column(Storage="_ENTRY_ID", DbType="VarChar(95) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_IS_VOLATILE", DbType="VarChar(1) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_INSTANCE_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_FIRED_TIME", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_STATE", DbType="VarChar(16) NOT NULL", CanBeNull=false)]
		public string STATE
		{
			get
			{
		...
		[Column(Storage="_JOB_NAME", DbType="VarChar(200)")]
		...
		[Column(Storage="_JOB_GROUP", DbType="VarChar(200)")]
		...
		[Column(Storage="_IS_STATEFUL", DbType="VarChar(1)")]
		...
		[Column(Storage="_REQUESTS_RECOVERY", DbType="VarChar(1)")]
	...
	[Table(Name="dbo.QRTZ_JOB_DETAILS")]
    ...
    partial void OnJOB_DATAChanged();
		...
		[Column(Storage="_JOB_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string JOB_NAME
		{
			get
			{
		...
		[Column(Storage="_JOB_GROUP", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string JOB_GROUP
		{
			get
			{
		...
		[Column(Storage="_JOB_CLASS_NAME", DbType="VarChar(250) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_IS_DURABLE", DbType="VarChar(1) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_IS_STATEFUL", DbType="VarChar(1) NOT NULL", CanBeNull=false)]
		public string IS_STATEFUL
		{
			get
			{
		...
		[Column(Storage="_REQUESTS_RECOVERY", DbType="VarChar(1) NOT NULL", CanBeNull=false)]
		public string REQUESTS_RECOVERY
		{
			get
			{
		...
		[Column(Storage="_JOB_DATA", DbType="Image", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="FK_QRTZ_JOB_LISTENERS_QRTZ_JOB_DETAILS", Storage="_QRTZ_JOB_LISTENERs", ThisKey="JOB_NAME,JOB_GROUP", OtherKey="JOB_NAME,JOB_GROUP", DeleteRule="CASCADE")]
		...
		[Association(Name="FK_QRTZ_TRIGGERS_QRTZ_JOB_DETAILS", Storage="_QRTZ_TRIGGERs", ThisKey="JOB_NAME,JOB_GROUP", OtherKey="JOB_NAME,JOB_GROUP", DeleteRule="NO ACTION")]
	...
	[Table(Name="dbo.QRTZ_JOB_LISTENERS")]
    ...
    partial void OnJOB_LISTENERChanged();
		...
		[Column(Storage="_JOB_LISTENER", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Association(Name="FK_QRTZ_JOB_LISTENERS_QRTZ_JOB_DETAILS", Storage="_QRTZ_JOB_DETAIL", ThisKey="JOB_NAME,JOB_GROUP", OtherKey="JOB_NAME,JOB_GROUP", IsForeignKey=true, DeleteOnNull=true)]
    ...
    partial void OnLOCK_NAMEChanged();
		...
		[Column(Storage="_LOCK_NAME", DbType="VarChar(40) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
	...
	[Table(Name="dbo.QRTZ_PAUSED_TRIGGER_GRPS")]
	...
	[Table(Name="dbo.QRTZ_Scheduler_STATE")]
    ...
    partial void OnCHECKIN_INTERVALChanged();
		...
		[Column(Storage="_INSTANCE_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string INSTANCE_NAME
		{
			get
			{
		...
		[Column(Storage="_LAST_CHECKIN_TIME", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_CHECKIN_INTERVAL", DbType="BigInt NOT NULL")]
	...
	[Table(Name="dbo.QRTZ_SIMPLE_TRIGGERS")]
    ...
    partial void OnTIMES_TRIGGEREDChanged();
		...
		[Column(Storage="_REPEAT_COUNT", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_REPEAT_INTERVAL", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_TIMES_TRIGGERED", DbType="BigInt NOT NULL")]
		...
		[Association(Name="FK_QRTZ_SIMPLE_TRIGGERS_QRTZ_TRIGGERS", Storage="_QRTZ_TRIGGER", ThisKey="TRIGGER_NAME,TRIGGER_GROUP", OtherKey="TRIGGER_NAME,TRIGGER_GROUP", IsForeignKey=true, DeleteOnNull=true)]
		public QRTZ_TRIGGER QRTZ_TRIGGER
		{
			get
			{
	...
	[Table(Name="dbo.QRTZ_TRIGGER_LISTENERS")]
    ...
    partial void OnTRIGGER_LISTENERChanged();
		...
		[Column(Storage="_TRIGGER_LISTENER", DbType="VarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Association(Name="FK_QRTZ_TRIGGER_LISTENERS_QRTZ_TRIGGERS", Storage="_QRTZ_TRIGGER", ThisKey="TRIGGER_NAME,TRIGGER_GROUP", OtherKey="TRIGGER_NAME,TRIGGER_GROUP", IsForeignKey=true, DeleteOnNull=true)]
		public QRTZ_TRIGGER QRTZ_TRIGGER
		{
			get
			{
    ...
    partial void OnJOB_DATAChanged();
		...
		[Column(Storage="_JOB_NAME", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
		public string JOB_NAME
		{
			get
			{
		...
		[Column(Storage="_JOB_GROUP", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
		public string JOB_GROUP
		{
			get
			{
		...
		[Column(Storage="_NEXT_FIRE_TIME", DbType="BigInt")]
		...
		[Column(Storage="_PREV_FIRE_TIME", DbType="BigInt")]
		...
		[Column(Storage="_TRIGGER_STATE", DbType="VarChar(16) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_TRIGGER_TYPE", DbType="VarChar(8) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_START_TIME", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_END_TIME", DbType="BigInt")]
		...
		[Column(Storage="_CALENDAR_NAME", DbType="VarChar(200)")]
		public string CALENDAR_NAME
		{
			get
			{
		...
		[Column(Storage="_MISFIRE_INSTR", DbType="SmallInt")]
		...
		[Association(Name="FK_QRTZ_CRON_TRIGGERS_QRTZ_TRIGGERS", Storage="_QRTZ_CRON_TRIGGER", ThisKey="TRIGGER_NAME,TRIGGER_GROUP", OtherKey="TRIGGER_NAME,TRIGGER_GROUP", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_QRTZ_SIMPLE_TRIGGERS_QRTZ_TRIGGERS", Storage="_QRTZ_SIMPLE_TRIGGER", ThisKey="TRIGGER_NAME,TRIGGER_GROUP", OtherKey="TRIGGER_NAME,TRIGGER_GROUP", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_QRTZ_TRIGGER_LISTENERS_QRTZ_TRIGGERS", Storage="_QRTZ_TRIGGER_LISTENERs", ThisKey="TRIGGER_NAME,TRIGGER_GROUP", OtherKey="TRIGGER_NAME,TRIGGER_GROUP", DeleteRule="CASCADE")]
		...
		[Association(Name="FK_QRTZ_TRIGGERS_QRTZ_JOB_DETAILS", Storage="_QRTZ_JOB_DETAIL", ThisKey="JOB_NAME,JOB_GROUP", OtherKey="JOB_NAME,JOB_GROUP", IsForeignKey=true)]
		public QRTZ_JOB_DETAIL QRTZ_JOB_DETAIL
		{
			get
			{
