...
namespace Wonga.QA.Framework.Db.CardPayment
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="CardPayment")]
	...
	[Table(Name="cardpayment.Schedules")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_ScheduleDate", DbType="Date NOT NULL")]
		...
		[Column(Storage="_ServiceLoginId", DbType="Int NOT NULL")]
		...
		[Association(Name="FK_Schedules_ServiceLogins", Storage="_ServiceLoginEntity", ThisKey="ServiceLoginId", OtherKey="ServiceLoginId", IsForeignKey=true)]
	...
	[Table(Name="cardpayment.ServiceLogins")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_ServiceLoginId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ServiceLoginId
		{
			get
			{
		...
		[Association(Name="FK_Schedules_ServiceLogins", Storage="_Schedules", ThisKey="ServiceLoginId", OtherKey="ServiceLoginId", DeleteRule="NO ACTION")]
