...
namespace Wonga.QA.Framework.Db.Payments
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Payments")]
	...
	[Table(Name="payment.AccountPreferences")]
    ...
    partial void OnCanAddBankAccountChanged();
		...
		[Column(Storage="_AccountPreferenceId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PrimaryBankAccountId", DbType="Int")]
		...
		[Column(Storage="_PrimaryPaymentCardId", DbType="Int")]
		...
		[Column(Storage="_IsHardship", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_RemindBeforeEndLoan", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_IsDispute", DbType="Bit NOT NULL")]
		...
		[Column(Storage="_Ccin", DbType="NVarChar(255)")]
		public string Ccin
		{
			get
			{
		...
		[Column(Storage="_CanAddBankAccount", DbType="Bit NOT NULL")]
		...
		[Association(Name="FK_AccountPreferences_BankAccountsBase", Storage="_BankAccountsBaseEntity", ThisKey="PrimaryBankAccountId", OtherKey="BankAccountId", IsForeignKey=true)]
		...
		[Association(Name="FK_AccountPreferences_PaymentCardsBase", Storage="_PaymentCardsBaseEntity", ThisKey="PrimaryPaymentCardId", OtherKey="PaymentCardId", IsForeignKey=true)]
	...
	[Table(Name="payment.AccountsApplications")]
    ...
    partial void OnDeactivatedOnChanged();
		...
		[Column(Storage="_ApplicationId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_SignedOn", DbType="DateTime")]
		...
		[Column(Storage="_DeactivatedOn", DbType="DateTime")]
		...
		[Association(Name="FK_AccountsApplications_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_AffiliateId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ExternalId", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="FK_PromoCodes_Affiliates", Storage="_PromoCodes", ThisKey="AffiliateId", OtherKey="AffiliateId", DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.Applications")]
    ...
    partial void OnDeclinedOnChanged();
		...
		[Column(Storage="_ApplicationId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		public int ApplicationId
		{
			get
			{
		...
		[Column(Storage="_ExternalId", DbType="UniqueIdentifier NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AccountId", DbType="UniqueIdentifier NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public System.Guid AccountId
		{
			get
			{
		...
		[Column(Storage="_Currency", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int Currency
		{
			get
			{
		...
		[Column(Storage="_BankAccountGuid", DbType="UniqueIdentifier NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_PaymentCardGuid", DbType="UniqueIdentifier NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_PromoCodeId", DbType="Int", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ApplicationDate", DbType="DateTime NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_SignedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<System.DateTime> SignedOn
		{
			get
			{
		...
		[Column(Storage="_ClosedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_CanceledOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AcceptedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_DeclinedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="FK_AccountsApplications_Applications", Storage="_AccountsApplications", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_Applications_Products", Storage="_ProductEntity", ThisKey="ProductId", OtherKey="ProductId", IsForeignKey=true)]
		...
		[Association(Name="FK_Arrears_Applications", Storage="_ArrearEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_BankGatewayFailedTransactions_Applications", Storage="_BankGatewayFailedTransactions", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_BusinessFixedInstallmentLoanApplications_Applications", Storage="_BusinessFixedInstallmentLoanApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_FixedTermLoanApplications_Applications", Storage="_FixedTermLoanApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_PaymentPlan_Applications", Storage="_PaymentPlans", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_RepaymentRequestDetails_Applications", Storage="_RepaymentRequestDetails", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_ScheduledPayments_Applications", Storage="_ScheduledPayments", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_Transactions_Applications", Storage="_Transactions", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_ArrearId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ArrearId
		{
			get
			{
		...
		[Association(Name="FK_Arrears_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
	...
	[Table(Name="payment.BankAccountsBase")]
    ...
    partial void OnVersionChanged();
		...
		[Column(Storage="_BankAccountId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_BankName", DbType="NVarChar(255) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_BankCode", DbType="NVarChar(10) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AccountNumber", DbType="NVarChar(20) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AccountType", DbType="NVarChar(25)", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_HolderName", DbType="NVarChar(255) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_AccountOpenDate", DbType="Date NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_CountryCode", DbType="NChar(2) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ValidatedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ValidateFailedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_DeletedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="FK__BusinessB__BankA__0F624AF8", Storage="_BusinessBankAccountEntity", ThisKey="BankAccountId", OtherKey="BankAccountId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK__PersonalB__BankA__0A9D95DB", Storage="_PersonalBankAccountEntity", ThisKey="BankAccountId", OtherKey="BankAccountId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_AccountPreferences_BankAccountsBase", Storage="_AccountPreferences", ThisKey="BankAccountId", OtherKey="PrimaryBankAccountId", DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.BankGatewayFailedTransactions")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_Direction", DbType="TinyInt NOT NULL")]
		...
		[Column(Storage="_Amount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_ErrorCode", DbType="NVarChar(10)")]
		...
		[Column(Storage="_PaymentReference", DbType="VarChar(50)")]
		...
		[Column(Storage="_Resolved", DbType="Bit NOT NULL")]
		...
		[Association(Name="FK_BankGatewayFailedTransactions_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
	...
	[Table(Name="payment.BusinessBankAccounts")]
    ...
    partial void OnOrganisationIdChanged();
		...
		[Column(Storage="_BankAccountId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int BankAccountId
		{
			get
			{
		...
		[Association(Name="FK__BusinessB__BankA__0F624AF8", Storage="_BankAccountsBaseEntity", ThisKey="BankAccountId", OtherKey="BankAccountId", IsForeignKey=true)]
		public BankAccountsBaseEntity BankAccountsBaseEntity
		{
			get
			{
	...
	[Table(Name="payment.BusinessFixedInstallmentLoanApplications")]
    ...
    partial void OnBusinessPaymentCardGuidChanged();
		...
		[Column(Storage="_LoanAmount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_MonthlyInterestRate", DbType="Decimal(9,6) NOT NULL")]
		...
		[Column(Storage="_ApplicationFee", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_NumberOfWeeks", DbType="Int NOT NULL")]
		...
		[Column(Storage="_BusinessBankAccountGuid", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_BusinessPaymentCardGuid", DbType="UniqueIdentifier NOT NULL")]
		...
		[Association(Name="FK_BusinessFixedInstallmentLoanApplications_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
	...
	[Table(Name="payment.BusinessPaymentCards")]
    ...
    partial void OnOrganisationIdChanged();
		...
		[Column(Storage="_PaymentCardId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="FK_BusinessPaymentCards_PaymentCardsBase", Storage="_PaymentCardsBaseEntity", ThisKey="PaymentCardId", OtherKey="PaymentCardId", IsForeignKey=true)]
		public PaymentCardsBaseEntity PaymentCardsBaseEntity
		{
			get
			{
	...
	[Table(Name="payment.CalendarDates")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_CalendarDateId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	...
	[Table(Name="payment.ExternalPaymentCards")]
    ...
    partial void OnPostCodeChanged();
		...
		[Column(Storage="_AddressLine1", DbType="NVarChar(200) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_AddressLine2", DbType="NVarChar(200)")]
		...
		[Column(Storage="_Town", DbType="NVarChar(200) NOT NULL", CanBeNull=false)]
		public string Town
		{
			get
			{
		...
		[Column(Storage="_County", DbType="NVarChar(200)")]
		...
		[Column(Storage="_PostCode", DbType="NVarChar(200) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="payment.FixedTermLoanApplications")]
    ...
    partial void OnInitiationFeeChanged();
		...
		[Column(Storage="_TransmissionFee", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_PromiseDate", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_IsV2", DbType="Bit")]
		...
		[Column(Storage="_ServiceFee", DbType="Decimal(9,2)")]
		...
		[Column(Storage="_InitiationFee", DbType="Decimal(9,2)")]
		...
		[Association(Name="FK_FixedTermLoanApplications_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
		...
		[Association(Name="FK_Topups_FixedTermLoanApplications", Storage="_Topups", ThisKey="ApplicationId", OtherKey="ApplicationId", DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.InstitutionBranchCodes")]
    ...
    partial void OnBranchCodeChanged();
		...
		[Column(Storage="_InstitutionCode", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_BranchCode", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="payment.LoanExtensions")]
    ...
    partial void OnSignedOnChanged();
		...
		[Column(Storage="_LoanExtensionId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ExtendDate", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_PartPaymentAmount", DbType="Decimal(9,2) NOT NULL")]
	...
	[Table(Name="payment.LoanLimitations")]
    ...
    partial void OnMaxLoansCountChanged();
		...
		[Column(Storage="_MaxLoansCount", DbType="Int")]
	...
	[Table(Name="payment.LoanSignups")]
	...
	[Table(Name="payment.LookupDictionaries")]
    ...
    partial void OnValueChanged();
		...
		[Column(Storage="_LookupId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int LookupId
		{
			get
			{
		...
		[Column(Storage="_DataKey", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="payment.PaymentCardHistoryData")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_HistoryDataId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CardExternalId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_AccountPreferenceId", DbType="Int NOT NULL")]
		public int AccountPreferenceId
		{
			get
			{
		...
		[Column(Storage="_AccountPreferenceExternalId", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_HolderName", DbType="NVarChar(100)")]
		public string HolderName
		{
			get
			{
		...
		[Column(Storage="_MaskedNumber", DbType="NVarChar(19) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ExpiryDate", DbType="Date NOT NULL")]
		...
		[Column(Storage="_IssueNo", DbType="NChar(3)")]
		...
		[Column(Storage="_IsCreditCard", DbType="Bit")]
		...
		[Column(Storage="_CardCreatedOn", DbType="DateTime")]
		...
		[Column(Storage="_CardCreatedBy", DbType="NVarChar(50)")]
	...
	[Table(Name="payment.PaymentCardHistoryItems")]
    ...
    partial void OnHistoryDataIdChanged();
		...
		[Column(Storage="_PaymentCardHistoryItemId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_UpdateType", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ActionPerformedBy", DbType="Int NOT NULL")]
		...
		[Column(Storage="_HistoryDataId", DbType="Int")]
	...
	[Table(Name="payment.PaymentCards")]
    ...
    partial void OnDeactivateReasonChanged();
		...
		[Column(Storage="_PaymentCardId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		public int PaymentCardId
		{
			get
			{
		...
		[Column(Storage="_HolderName", DbType="NVarChar(100)", UpdateCheck=UpdateCheck.Never)]
		public string HolderName
		{
			get
			{
		...
		[Column(Storage="_MaskedNumber", DbType="NVarChar(19) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public string MaskedNumber
		{
			get
			{
		...
		[Column(Storage="_ExpiryDate", DbType="Date NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public System.DateTime ExpiryDate
		{
			get
			{
		...
		[Column(Storage="_IssueNo", DbType="NChar(3)", UpdateCheck=UpdateCheck.Never)]
		public string IssueNo
		{
			get
			{
		...
		[Column(Storage="_IsCreditCard", DbType="Bit", UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<bool> IsCreditCard
		{
			get
			{
		...
		[Column(Storage="_DeactivatedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<System.DateTime> DeactivatedOn
		{
			get
			{
		...
		[Column(Storage="_AuthorizedOn", DbType="DateTime", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsExternalCard", DbType="Bit", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_DeactivateReason", DbType="Int", UpdateCheck=UpdateCheck.Never)]
	...
	[Table(Name="payment.PaymentCardsBase")]
    ...
    partial void OnDeactivateReasonChanged();
		...
		[Association(Name="FK_AccountPreferences_PaymentCardsBase", Storage="_AccountPreferences", ThisKey="PaymentCardId", OtherKey="PrimaryPaymentCardId", DeleteRule="NO ACTION")]
		public EntitySet<AccountPreferenceEntity> AccountPreferences
		{
			get
			{
		...
		[Association(Name="FK_BusinessPaymentCards_PaymentCardsBase", Storage="_BusinessPaymentCardEntity", ThisKey="PaymentCardId", OtherKey="PaymentCardId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_PersonalPaymentCards_PaymentCardsBase", Storage="_PersonalPaymentCardEntity", ThisKey="PaymentCardId", OtherKey="PaymentCardId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.PaymentPlan")]
    ...
    partial void OnOutstandingInterestChanged();
		...
		[Column(Storage="_PaymentPlanId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_EndDate", DbType="Date NOT NULL")]
		...
		[Column(Storage="_RegularAmount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_FinalAmount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_NumberOfPayments", DbType="Int NOT NULL")]
		...
		[Column(Storage="_CanceledOn", DbType="DateTime")]
		public System.Nullable<System.DateTime> CanceledOn
		{
			get
			{
		...
		[Column(Storage="_PaymentIntervalInDays", DbType="Int NOT NULL")]
		...
		[Column(Storage="_OutstandingPrincipal", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_OutstandingFees", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_OutstandingInterest", DbType="Decimal(9,2) NOT NULL")]
		...
		[Association(Name="FK_PaymentPlan_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
	...
	[Table(Name="payment.PersonalBankAccounts")]
    ...
    partial void OnAccountIdChanged();
		...
		[Association(Name="FK__PersonalB__BankA__0A9D95DB", Storage="_BankAccountsBaseEntity", ThisKey="BankAccountId", OtherKey="BankAccountId", IsForeignKey=true)]
		public BankAccountsBaseEntity BankAccountsBaseEntity
		{
			get
			{
	...
	[Table(Name="payment.PersonalPaymentCards")]
    ...
    partial void OnAccountIdChanged();
		...
		[Association(Name="FK_PersonalPaymentCards_PaymentCardsBase", Storage="_PaymentCardsBaseEntity", ThisKey="PaymentCardId", OtherKey="PaymentCardId", IsForeignKey=true)]
		public PaymentCardsBaseEntity PaymentCardsBaseEntity
		{
			get
			{
	...
	[Table(Name="payment.ProductInterestRates")]
    ...
    partial void OnVariableInterestRateIdChanged();
		...
		[Column(Storage="_ProductInterestRateId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_InterestType", DbType="Int NOT NULL")]
		...
		[Column(Storage="_LoanDayStart", DbType="Int")]
		...
		[Column(Storage="_LoanDayEnd", DbType="Int")]
		...
		[Column(Storage="_VariableInterestRateId", DbType="Int")]
		...
		[Association(Name="FK_ProductInterestRates_Products", Storage="_ProductEntity", ThisKey="ProductId", OtherKey="ProductId", IsForeignKey=true)]
		public ProductEntity ProductEntity
		{
			get
			{
		...
		[Association(Name="FK_ProductInterestRates_VariableInterestRates", Storage="_VariableInterestRateEntity", ThisKey="VariableInterestRateId", OtherKey="VariableInterestRateId", IsForeignKey=true)]
    ...
    partial void OnServiceFeeChanged();
		...
		[Column(Storage="_AmountMin", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_AmountMax", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_TermMin", DbType="Int NOT NULL")]
		public int TermMin
		{
			get
			{
		...
		[Column(Storage="_TermMax", DbType="Int NOT NULL")]
		public int TermMax
		{
			get
			{
		...
		[Column(Storage="_NeedSignTAndC", DbType="Bit NOT NULL")]
		...
		[Association(Name="FK_Applications_Products", Storage="_Applications", ThisKey="ProductId", OtherKey="ProductId", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_ProductInterestRates_Products", Storage="_ProductInterestRates", ThisKey="ProductId", OtherKey="ProductId", DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.PromoCampaigns")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_PromoCampaignId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CampaignName", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_InterestDiscount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_TransferFeeDiscount", DbType="Decimal(9,2) NOT NULL")]
		...
		[Column(Storage="_Reward", DbType="Decimal(9,2) NOT NULL")]
		...
		[Association(Name="FK_PromoCodes_PromoCampaigns", Storage="_PromoCodes", ThisKey="PromoCampaignId", OtherKey="PromoCampaignId", DeleteRule="NO ACTION")]
		public EntitySet<PromoCodeEntity> PromoCodes
		{
			get
			{
    ...
    partial void OnOwnerAccountIdChanged();
		...
		[Column(Storage="_PromoCodeId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PromoCampaignId", DbType="Int NOT NULL")]
		public int PromoCampaignId
		{
			get
			{
		...
		[Column(Storage="_CustomerTypeRangeKind", DbType="Int")]
		...
		[Column(Storage="_CustomerTypeRangeItems", DbType="NVarChar(500)")]
		...
		[Column(Storage="_AffiliateId", DbType="Int")]
		...
		[Column(Storage="_OwnerAccountId", DbType="UniqueIdentifier")]
		...
		[Association(Name="FK_PromoCodes_Affiliates", Storage="_AffiliateEntity", ThisKey="AffiliateId", OtherKey="AffiliateId", IsForeignKey=true)]
		...
		[Association(Name="FK_PromoCodes_PromoCampaigns", Storage="_PromoCampaignEntity", ThisKey="PromoCampaignId", OtherKey="PromoCampaignId", IsForeignKey=true)]
		...
		[Association(Name="FK_PromoCodesUsage_PromoCodes", Storage="_PromoCodesUsages", ThisKey="PromoCodeId", OtherKey="PromoCodeId", DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.PromoCodesUsage")]
    ...
    partial void OnUsageDateChanged();
		...
		[Column(Storage="_PromoCodesUsageId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PromoCodeId", DbType="Int NOT NULL")]
		public int PromoCodeId
		{
			get
			{
		...
		[Column(Storage="_UsageDate", DbType="DateTime NOT NULL")]
		...
		[Association(Name="FK_PromoCodesUsage_PromoCodes", Storage="_PromoCodeEntity", ThisKey="PromoCodeId", OtherKey="PromoCodeId", IsForeignKey=true)]
	...
	[Table(Name="payment.RepaymentArrangementDetails")]
    ...
    partial void OnTrackingDaysChanged();
		...
		[Column(Storage="_RepaymentArrangementDetailId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_RepaymentArrangementId", DbType="Int NOT NULL")]
		...
		[Column(Storage="_Currency", DbType="Int NOT NULL")]
		public int Currency
		{
			get
			{
		...
		[Column(Storage="_PaymentRecievedOn", DbType="DateTime")]
		...
		[Column(Storage="_AmountPaid", DbType="Decimal(9,2) NOT NULL")]
		...
		[Association(Name="FK_RepaymentArrangementDetails_RepaymentArrangements", Storage="_RepaymentArrangementEntity", ThisKey="RepaymentArrangementId", OtherKey="RepaymentArrangementId", IsForeignKey=true)]
	...
	[Table(Name="payment.RepaymentArrangements")]
    ...
    partial void OnCanceledOnChanged();
		...
		[Column(Storage="_RepaymentArrangementId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int RepaymentArrangementId
		{
			get
			{
		...
		[Column(Storage="_IsBroken", DbType="Bit")]
		...
		[Association(Name="FK_RepaymentArrangementDetails_RepaymentArrangements", Storage="_RepaymentArrangementDetails", ThisKey="RepaymentArrangementId", OtherKey="RepaymentArrangementId", DeleteRule="NO ACTION")]
	...
	[Table(Name="payment.RepaymentRequestDetails")]
    ...
    partial void OnCreatedOnChanged();
		...
		[Column(Storage="_RepaymentRequestDetailId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_RepaymentRequestId", DbType="Int NOT NULL")]
		...
		[Column(Storage="_StatusCode", DbType="Int")]
		...
		[Column(Storage="_StatusMessage", DbType="NVarChar(200)")]
		...
		[Association(Name="FK_RepaymentRequestDetails_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
		...
		[Association(Name="FK_RepaymentRequestDetails_RepaymentRequests", Storage="_RepaymentRequestEntity", ThisKey="RepaymentRequestId", OtherKey="RepaymentRequestId", IsForeignKey=true)]
	...
	[Table(Name="payment.RepaymentRequests")]
    ...
    partial void OnCashEntityIdChanged();
		...
		[Column(Storage="_RepaymentRequestId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int RepaymentRequestId
		{
			get
			{
		...
		[Column(Storage="_CashSource", DbType="Int NOT NULL")]
		...
		[Column(Storage="_CashEntityId", DbType="UniqueIdentifier")]
		...
		[Association(Name="FK_RepaymentRequestDetails_RepaymentRequests", Storage="_RepaymentRequestDetails", ThisKey="RepaymentRequestId", OtherKey="RepaymentRequestId", DeleteRule="NO ACTION")]
		public EntitySet<RepaymentRequestDetailEntity> RepaymentRequestDetails
		{
			get
			{
	...
	[Table(Name="payment.ScheduledPayments")]
    ...
    partial void OnIsRetryChanged();
		...
		[Column(Storage="_ScheduledPaymentId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_Success", DbType="Bit")]
		...
		[Association(Name="FK_ScheduledPayments_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
    ...
    partial void OnIsFailedChanged();
		...
		[Column(Storage="_TopupId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int TopupId
		{
			get
			{
		...
		[Column(Storage="_ProcessedOn", DbType="DateTime")]
		...
		[Column(Storage="_IsFailed", DbType="Bit NOT NULL")]
		...
		[Association(Name="FK_Topups_FixedTermLoanApplications", Storage="_FixedTermLoanApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public FixedTermLoanApplicationEntity FixedTermLoanApplicationEntity
		{
			get
			{
    ...
    partial void OnUserIdChanged();
		...
		[Column(Storage="_PostedOn", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_Scope", DbType="TinyInt NOT NULL")]
		public byte Scope
		{
			get
			{
		...
		[Column(Storage="_Type", DbType="NVarChar(40) NOT NULL", CanBeNull=false)]
		public string Type
		{
			get
			{
		...
		[Column(Storage="_Mir", DbType="Decimal(9,6)")]
		...
		[Column(Storage="_ComponentTransactionId", DbType="UniqueIdentifier")]
		...
		[Column(Storage="_Reference", DbType="NVarChar(50)")]
		...
		[Association(Name="FK_Transactions_Applications", Storage="_ApplicationEntity", ThisKey="ApplicationId", OtherKey="ApplicationId", IsForeignKey=true)]
		public ApplicationEntity ApplicationEntity
		{
			get
			{
		...
		[Association(Name="FK_Transactions_Users", Storage="_UserEntity", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_ExternalId", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string ExternalId
		{
			get
			{
		...
		[Association(Name="FK_Transactions_Users", Storage="_Transactions", ThisKey="UserId", OtherKey="UserId", DeleteRule="NO ACTION")]
		public EntitySet<TransactionEntity> Transactions
		{
			get
			{
	...
	[Table(Name="payment.VariableInterestRateDetails")]
    ...
    partial void OnMonthlyInterestRateChanged();
		...
		[Column(Storage="_VariableInterestRateDetailId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_VariableInterestRateId", DbType="Int NOT NULL")]
		...
		[Association(Name="FK_VariableInterestRateDetails_VariableInterestRates", Storage="_VariableInterestRateEntity", ThisKey="VariableInterestRateId", OtherKey="VariableInterestRateId", IsForeignKey=true)]
		public VariableInterestRateEntity VariableInterestRateEntity
		{
			get
			{
	...
	[Table(Name="payment.VariableInterestRates")]
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_VariableInterestRateId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int VariableInterestRateId
		{
			get
			{
		...
		[Association(Name="FK_ProductInterestRates_VariableInterestRates", Storage="_ProductInterestRates", ThisKey="VariableInterestRateId", OtherKey="VariableInterestRateId", DeleteRule="NO ACTION")]
		public EntitySet<ProductInterestRateEntity> ProductInterestRates
		{
			get
			{
		...
		[Association(Name="FK_VariableInterestRateDetails_VariableInterestRates", Storage="_VariableInterestRateDetails", ThisKey="VariableInterestRateId", OtherKey="VariableInterestRateId", DeleteRule="NO ACTION")]
