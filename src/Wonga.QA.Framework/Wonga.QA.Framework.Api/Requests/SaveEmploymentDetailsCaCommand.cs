...
{
    /// <summary> Wonga.Risk.Commands.Ca.SaveEmploymentDetails </summary>
    [XmlRoot("SaveEmploymentDetails")]
    public partial class SaveEmploymentDetailsCaCommand : ApiRequest<SaveEmploymentDetailsCaCommand>
    {
