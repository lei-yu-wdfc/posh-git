...
{
    /// <summary> Wonga.Comms.Commands.Za.SaveCustomerAddressZa </summary>
    [XmlRoot("SaveCustomerAddressZa")]
    public partial class SaveCustomerAddressZaCommand : ApiRequest<SaveCustomerAddressZaCommand>
    {
