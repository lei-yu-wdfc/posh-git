...
namespace Wonga.QA.Framework.Msmq.Messages.Risk.Commands.UK
{
    /// <summary> Wonga.Risk.Commands.UK.SaveEmploymentDetailsMessage </summary>
    [XmlRoot("SaveEmploymentDetailsMessage", Namespace = "Wonga.Risk.Commands.UK", DataType = "" )
    , SourceAssembly("Wonga.Risk.Commands.UK, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")]
