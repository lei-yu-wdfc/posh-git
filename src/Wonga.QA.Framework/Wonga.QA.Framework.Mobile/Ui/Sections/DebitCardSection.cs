...
namespace Wonga.QA.Framework.Mobile.Ui.Sections
{
    public class DebitCardSection : BaseSection
    {
            ...
            : base(UiMapMobile.Get.DebitCardSection.Fieldset, page)
        {
            ...
            _cardExpiryDateMonth = Section.FindElement(By.CssSelector(UiMapMobile.Get.DebitCardSection.CardExpiryDateMonth));
            _cardExpiryDateYear = Section.FindElement(By.CssSelector(UiMapMobile.Get.DebitCardSection.CardExpiryDateYear));
            _cardStartDateMonth = Section.FindElement(By.CssSelector(UiMapMobile.Get.DebitCardSection.CardStartDateMonth));
            _cardStartDateYear = Section.FindElement(By.CssSelector(UiMapMobile.Get.DebitCardSection.CardStartDateYear));
