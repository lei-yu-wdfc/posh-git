...
namespace Wonga.QA.UiTests.Web.PayLater
{
    ...
    {
        [Test, AUT(AUT.Uk), JIRA("QA-77, 79, 80, 81"), Explicit("works on local dev only")]
        ...
        [Test, AUT(AUT.Uk), JIRA("QA-78"), Explicit("works on local dev only")]
        ...
        [Test, AUT(AUT.Uk), JIRA("QA-82, 75, 84, 86, 89"), Explicit("works on local dev only")]
        ...
        [Test, AUT(AUT.Uk), JIRA("QA-92"), Explicit("works on local dev only")]
