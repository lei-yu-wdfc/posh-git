...
namespace Wonga.QA.Tests.Ui
{
    ...
    {
        [Test, AUT(AUT.Uk), JIRA("UKOPS-704"), MultipleAsserts, Owner(Owner.SaveliyProkopenko), Category(TestCategories.SmokeTest), Pending("Financial Assessment")]
        ...
        [Test, AUT(AUT.Uk), JIRA("UKOPS-704"), Owner(Owner.SaveliyProkopenko), Category(TestCategories.SmokeTest), Pending("Financial Assessment")]
