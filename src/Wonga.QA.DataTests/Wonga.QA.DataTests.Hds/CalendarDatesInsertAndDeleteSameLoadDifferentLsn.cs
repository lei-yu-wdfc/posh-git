...
//Step12: reset jobs to original state

namespace Wonga.QA.DataTests.Hds
{
    [TestFixture]
    class CalendarDatesInsertAndDeleteSameLoadDifferentLsn
    {
        [Test]
        [AUT(AUT.Uk)]
        ...
        public void CalendarDatesInsert()
        {
            ...
            Trace.WriteLine("Deleing the same record from  Payments.payment.CalendarDates table.");
            ...
            //
            //Step5: Select the Deleted  record from cdcstaging and store into a variable to compare with hds data  --the record with _$Operation=1
            //
            ...
            //
            //Step10: Checking record exist in hds with correct hdslsn,hdsfrm and hdsTo after delete and HdsDeleteFlag  set 1 and also number of record should be 1
            //
